...
We impute the missing values following the principales stated for [imputeTS](https://cran.r-project.org/web/packages/imputeTS/vignettes/imputeTS-Time-Series-Missing-Value-Imputation-in-R.pdf). Thanks to this approach we almost double the amount of data for analysis by province (It was selected "na_seadec" function due to it covers seasonality aspects -weekdays/weekends in our case-).
...
Box-Cox transformation (lambda is obtained using "guerrero" feature -fpp3-) and double difference is plotted (lag=7).
...
### Univariate (7, 14, 21 days) Madrid, Málaga Cádiz and Sevilla
